                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
                    	...
                    	<!-- 
                    		...
                    		생각보다 어려운곳도 사실이다. 대표적으로는 브라우저의 엔진별 로직과 시점이다. 사용자가 사용하는 다양한
                    		...
                    		- onsubmit="return 함수명"으로 사용
                    			> return을 부여하는건 해당 함수가 실행 될 때, 정상적으로 처리되면 true, 값의 필터에 의해 처리 결과가
                    			    비정상적일땐 false를 리턴한다.
                    			> 이때, submit 이벤트가 발생하지 않는다.
                    			
                    		# onclick 속성 이벤트 활용
                    		- input type button의 onclick 속성의 요소를 활용
                    		- inout type button Element에 "click" 이벤트 활용
                    	 -->
