            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<table class="table table-striped table-bordered table-hover mt-4">
							...
							<tbody>
								...
								<c:choose>
									...
									<c:otherwise>
										<!-- Display the table rows when there are records -->
										<c:forEach items="${boardList}" var="v" varStatus="s">
											<tr>
												<td>${v.no}</td>
												<td><a href="boardView.jsp?no=${v.no}">${v.title}</a></td>
												<td>${v.writer}</td>
												<td>${v.regDate}</td>
												<td>${v.hit}</td>
											</tr>
					    ...
					    <a href="boardForm.jsp" class="btn btn-primary">게시글 등록</a>
					</div>
                </div>
            </div>
        </div>
